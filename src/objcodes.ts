...
export const ObjCodes: TObjCodes = {
    ...
    AnnouncementOptOut: AnnouncementOptOut,
    ...
    ApprovalProcessAttachable: ApprovalProcessAttachable,
    ...
    CalendarFeedEntry: CalendarFeedEntry,
    ...
    CategoryCascadeRule: CategoryCascadeRule,
    CategoryCascadeRuleMatch: CategoryCascadeRuleMatch,
    CategoryParameter: CategoryParameter,
    CategoryParameterExpression: CategoryParameterExpression,
    Company: Company,
    ComponentKey: ComponentKey,
    ContextSensitiveHelp: ContextSensitiveHelp,
    CustomEnum: CustomEnum,
    CustomEnumOrder: CustomEnumOrder,
    CustomLabel: CustomLabel,
    CustomMenu: CustomMenu,
    CustomMenuCustomMenu: CustomMenuCustomMenu,
    CustomQuarter: CustomQuarter,
    Customer: Customer,
    CustomerDeletion: CustomerDeletion,
    CustomerFeedback: CustomerFeedback,
    CustomerPreferences: CustomerPreferences,
    CustomerTimelineCalc: CustomerTimelineCalc,
    CustsSections: CustsSections,
    ...
    DocumentProviderConfig: DocumentProviderConfig,
    DocumentProviderMetadata: DocumentProviderMetadata,
    DocumentRequest: DocumentRequest,
    DocumentShare: DocumentShare,
    DocumentTaskStatus: DocumentTaskStatus,
    DocumentVersion: DocumentVersion,
    Email: Email,
    EmailTemplate: EmailTemplate,
    Endorsement: Endorsement,
    EndorsementShare: EndorsementShare,
    EventHandler: EventHandler,
    EventSubscription: EventSubscription,
    EwsFileHandle: EwsFileHandle,
    ...
    InstalledDDItem: InstalledDDItem,
    Iteration: Iteration,
    JournalEntry: JournalEntry,
    JournalField: JournalField,
    KickStart: KickStart,
    LayoutTemplate: LayoutTemplate,
    LayoutTemplateDatePreference: LayoutTemplateDatePreference,
    LayoutTemplatePage: LayoutTemplatePage,
    ...
    PrivateCustomerPref: PrivateCustomerPref,
    Program: Program,
    Project: Project,
    ...
    Rate: Rate,
    Recent: Recent,
    RecentMenuItem: RecentMenuItem,
    RecentUpdate: RecentUpdate,
    RecurrenceRule: RecurrenceRule,
    RemovedDocumentVersion: RemovedDocumentVersion,
    ...
    ScoreCardOption: ScoreCardOption,
    ScoreCardQuestion: ScoreCardQuestion,
    SearchEvent: SearchEvent,
    SecurityAncestor: SecurityAncestor,
    Sequence: Sequence,
    ...
    TemplatePredecessor: TemplatePredecessor,
    TemplateTask: TemplateTask,
    TemplateUser: TemplateUser,
    TemplateUserRole: TemplateUserRole,
    ...
    UserNote: UserNote,
    UserObjectPref: UserObjectPref,
    UserPrefValue: UserPrefValue,
    UserResource: UserResource,
    UsersSections: UsersSections,
    Work: Work,
    WorkItem: WorkItem
}
